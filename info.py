...
API_ID = int(environ.get('35006907', ''))
API_HASH = environ.get('680630acd2626f37829cdc3d93e9a177', '')
BOT_TOKEN = environ.get('7770884431:AAFwHiuQsGVGCny8rmJVdoyI56vIehCPz5Q', '')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('5048967308', '1892771262').split()]
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://luckydrive501:<luckydrive501>@luckydrive500.tf9isen.mongodb.net/?appName=Luckydrive500', "")
DATABASE_NAME = environ.get('luckydrive500')
COLLECTION_NAME = environ.get('sb_files')

# File Channel Settings
FILE_CHANNELS = [int(ch) for ch in environ.get('-1002727057163', '-1002831639976 -1002607076908 -1002869981026').split()]
...
# Others
LOG_CHANNEL = int(environ.get('-1003683878091'))
